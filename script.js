...
searchBtn.addEventListener("click", () => {
    let apiKey = "289808d5c97ed37fff84a396e2a034c2"
...
function createCard(cityData) {
    ...
    {
        weatherImgString = "https://www.freeiconspng.com/uploads/clouds-png-22.png";
        
    } 
    if(cityData.weather[0].main == "Clear") 
    {
        weatherImgString = "https://pngimg.com/uploads/sun/sun_PNG13410.png";
    } 
    if(cityData.weather[0].main == "Haze") 
    {
        weatherImgString = "https://clipartcraft.com/images/wind-clipart-weather-1.png";
    } 
    if(cityData.weather[0].main == "Rain") 
    {
        weatherImgString = "https://clipartspub.com/images/rain-clipart-transparent-background-4.png";
    } 
    if(cityData.weather[0].main == "Drizzle") 
    {
        weatherImgString = "https://clipground.com/images/tornado-black-and-white-clipart-3.jpg";
    } 
    if (cityData.weather[0].main == "Mist") 
    {
        weatherImgString = "https://www.pngrepo.com/png/227751/512/windy-wind.png";
    }
